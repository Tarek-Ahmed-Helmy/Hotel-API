        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuperServiceId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_Services_SuperServiceId",
                        column: x => x.SuperServiceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rooms_UseTypes_UseTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestHeaders_Hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestHeaders_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_RequestHeaders_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestDetails_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestDetails_StatusId",
                table: "RequestDetails",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestHeaders_HotelId",
                table: "RequestHeaders",
                column: "HotelId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestHeaders_RoomId",
                table: "RequestHeaders",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestHeaders_StatusId",
                table: "RequestHeaders",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_UseTypeId",
                table: "Rooms",
                column: "UseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Services_SuperServiceId",
                table: "Services",
                column: "SuperServiceId");
        }
